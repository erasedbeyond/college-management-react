...
class Teacher extends React.Component{
    ...
    getCourse = () =>{ //  getting all the course and its topics
        ...
        Axios({
            ...
            // url:'https://college-management-portal-app.herokuapp.com/get-course',
            url:URL+'teacher/get-course',
    ...
    getAssignmnets = () =>{
        Axios({
            ...
            // url:'https://college-management-portal-app.herokuapp.com/teacher/assignment-list',
            url:URL+'teacher/assignment-list',
    ...
    getStudents = () =>{
        Axios({
            ...
            // url:'https://college-management-portal-app.herokuapp.com/teacher/get-students',
            url:URL+'teacher/get-students',
